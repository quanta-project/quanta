...
fork of Quanta Core copies the merge. Instead, make any username mentions in a
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/quantanetwork-project/quantanetwork  # Fetch the latest upstream commit
...
projects such as libsecp256k1), and is not to be confused with overall Quanta
