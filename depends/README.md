...
Quanta Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Quanta Core

**When configuring Quanta Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Quanta Core:
...
variables will be set when generating the Quanta Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
