...
Assumeutxo is a feature that allows fast bootstrapping of a validating quantad
instance.
...
```
$ quanta-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ quanta-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
