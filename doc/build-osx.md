...
There is also a multifunction command line interface at `./build/bin/quanta`
supporting subcommands like `quanta node`, `quanta gui`, `quanta rpc`, and
others that can be listed with `quanta help`.
