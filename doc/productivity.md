...
```sh
cmake --build build --target quantad quanta-cli
cmake --build build --target quanta-qt
cmake --build build --target bench_quanta
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:quantanetwork-project/quantanetwork.git
```
