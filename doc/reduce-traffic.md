...
By default, Quanta Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that quanta's trustless model works best if you are
