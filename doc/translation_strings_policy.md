...
This document provides guidelines for internationalization of the Quanta Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Quanta network</source>
        <translation>
            <numerusform>%n active connection to Quanta network</numerusform>
            <numerusform>%n active connections to Quanta network</numerusform>
        </translation>
    </message>
